...
- 版本: v0.3.0
- Tests: 181 tests (168 passing, 13 async mark 既有 fail)
...
- MT5 同步：`MT5_SYNC_SETUP.md` + `mt5_sync.py`
- 每日反思：`daily_reflection.py`
- Demo：`demo.py`（30 筆模擬交易跑完整 L1→L2→L3 pipeline）
- 測試：`tests/`
